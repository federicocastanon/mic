...
class MY_Loader extends CI_Loader
{
    ...
    {
        $vars['_template_menu_content'] = $this->view($vars['_template_menu'], $vars, True);
        $vars['_template_content'] = $this->view($template, $vars, True);
        $this->view("templates/main", $vars, False);
    }
