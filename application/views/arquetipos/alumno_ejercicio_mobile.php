...
<form method='post' action='<?php echo base_url('/arquetipos/respuestasAnteriores/' . $ejercicio->id)?>'>
    ...
    <a class="btn btn-large pull-right"  href='<?php echo base_url('/arquetipos/link_publico/' . $ejercicio->public_id)?>'><i class="fa fa-arrow-left"></i> Volver</a>
        ...
        <div id="openModal<?php echo $i?>" class="modalResponder"> <!-- modal 5-->
            <div class="modal-dialog modal-lg">
                ...
                <textarea name="respuesta[<?php echo $img->id?>][<?php echo $preg->id?>]" rows="2"
                    ...
                    <a <?php if ($disabled):?>disabled<?php endif?> href='#' class='btn btn-large pull-left enviar' data-rel='<?php echo $img->id ?>'>
                        enviar respuestas
                    </a>
                    <br /><br />
